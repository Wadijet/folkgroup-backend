# Script chạy test cho Module 2 (AI Service)
# Sử dụng: .\api-tests\scripts\test-ai-service.ps1

$ErrorActionPreference = "Continue"

Write-Host "========================================" -ForegroundColor Cyan
Write-Host "  TEST MODULE 2 - AI SERVICE" -ForegroundColor Cyan
Write-Host "========================================" -ForegroundColor Cyan
Write-Host ""
...
# Chạy test
Write-Host ""
Write-Host "[INFO] Bắt đầu chạy test Module 2 (AI Service)..." -ForegroundColor Yellow
Write-Host ""

Set-Location "$projectRoot\api-tests"

# Chạy test với verbose output
go test -v -run TestAIServiceModule ./cases

$exitCode = $LASTEXITCODE

Write-Host ""
if ($exitCode -eq 0) {
    Write-Host "[SUCCESS] Test Module 2 hoàn thành thành công!" -ForegroundColor Green
} else {
    Write-Host "[FAILED] Test Module 2 có lỗi (exit code: $exitCode)" -ForegroundColor Red
}
