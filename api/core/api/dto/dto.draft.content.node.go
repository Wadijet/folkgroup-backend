...
type DraftContentNodeCreateInput struct {
	...
	ParentID          string `json:"parentId,omitempty"`                          // ID của parent node (production) (tùy chọn, dạng string ObjectID)
	ParentDraftID     string `json:"parentDraftId,omitempty"`                     // ID của parent draft node (tùy chọn, dạng string ObjectID)
	...
	WorkflowRunID     string `json:"workflowRunId,omitempty"`                     // ID của workflow run tạo ra draft này (tùy chọn, link về Module 2)
	CreatedByRunID    string `json:"createdByRunId,omitempty"`                    // ID của AI run (tùy chọn, link về Module 2)
	CreatedByStepRunID string `json:"createdByStepRunId,omitempty"`              // ID của step run (tùy chọn, link về Module 2)
	CreatedByCandidateID string `json:"createdByCandidateId,omitempty"`          // ID của candidate được chọn (tùy chọn, link về Module 2)
	CreatedByBatchID  string `json:"createdByBatchId,omitempty"`                  // ID của generation batch (tùy chọn, link về Module 2)
...
type DraftContentNodeUpdateInput struct {
	...
	ParentID          string `json:"parentId,omitempty"`                          // ID của parent node
	ParentDraftID     string `json:"parentDraftId,omitempty"`                     // ID của parent draft node
