...
> **Phân biệt thuật ngữ:** **Metric Layer 1/2/3** trong mục này là **các bước biến đổi output** trong Rule Intelligence (Ads, CIX, …), **không** phải **mirror/canonical L1-persist/L2-persist** trong Unified Data Contract, **không** phải trường BSON CRM `layer1`/`layer2`, **không** phải **Pha ghi thô / merge / intel** ingress. Bảng đầy đủ: [KHUNG_KHUON_MODULE_INTELLIGENCE.md](../../05-development/KHUNG_KHUON_MODULE_INTELLIGENCE.md) mục 0.
...
2. Dependency Resolution
   ...
   - Derivation: **metric layer** raw→L1 → L1→L2 → L2→L3 (*bước rule/from_layer→to_layer; không phải L1-persist/L2-persist mirror/canonical*)
