...
func SeedAdsMetricDefinitions(ctx context.Context) (int, error) {
	...
	seeds := []adsmodels.AdsMetricDefinition{
		...
		{Key: "orders_7d", Label: "Orders (7 ngày)", Description: "Số đơn Pancake trong 7 ngày", Unit: "số", Source: adsmodels.SourcePancakePos, Window: adsmodels.Window7d, WindowMs: windowMs(adsmodels.Window7d), Type: adsmodels.MetricTypeRaw, SourceCollection: global.MongoDB_ColNames.PcPosOrders, TimeField: "posCreatedAt", AggregationField: "posData.ad_id", OutputPath: "pancake.pos.orders", UseCase: "Conv_Rate_7day, MQS, Mess Trap", DocReference: "FolkForm 01", Order: 10, IsActive: true, CreatedAt: now, UpdatedAt: now},
		{Key: "revenue_7d", Label: "Revenue (7 ngày)", Description: "Doanh thu từ đơn hàng Pancake", Unit: "VND", Source: adsmodels.SourcePancakePos, Window: adsmodels.Window7d, WindowMs: windowMs(adsmodels.Window7d), Type: adsmodels.MetricTypeRaw, SourceCollection: global.MongoDB_ColNames.PcPosOrders, TimeField: "posCreatedAt", AggregationField: "posData.ad_id", OutputPath: "pancake.pos.revenue", UseCase: "ROAS, CPA Purchase", DocReference: "FolkForm 01", Order: 11, IsActive: true, CreatedAt: now, UpdatedAt: now},
		...
		// === RAW 1h — CB-1, HB-3 ===
		{Key: "orders_1h", Label: "Orders (1 giờ)", Description: "Số đơn Pancake trong 1h", Unit: "số", Source: adsmodels.SourcePancakePos, Window: adsmodels.Window1h, WindowMs: windowMs(adsmodels.Window1h), Type: adsmodels.MetricTypeRaw, SourceCollection: global.MongoDB_ColNames.PcPosOrders, TimeField: "posCreatedAt", AggregationField: "posData.ad_id", OutputPath: "orders", UseCase: "HB-3 Divergence", DocReference: "FolkForm 07, HB-3", Order: 30, IsActive: true, CreatedAt: now, UpdatedAt: now},
