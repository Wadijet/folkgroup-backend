...
// SendEmail gửi email
func SendEmail(ctx context.Context, sender *notifmodels.NotificationChannelSender, recipient string, template *RenderedTemplate, historyID string, baseURL string) error {
