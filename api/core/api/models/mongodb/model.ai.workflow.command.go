...
type AIWorkflowCommand struct {
	...
	// ===== COMMAND INFO =====
	CommandType string `json:"commandType" bson:"commandType" index:"single:1"` // Loại command: START_WORKFLOW
	...
	// ===== RESULTS =====
	WorkflowRunID *primitive.ObjectID  `json:"workflowRunId,omitempty" bson:"workflowRunId,omitempty" index:"single:1"` // ID của workflow run được tạo (nếu có)
