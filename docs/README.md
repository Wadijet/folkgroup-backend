...
- ✅ **2026-04-06**: [unified-data-contract.md](../docs-shared/architecture/data-contract/unified-data-contract.md) §1.7 + [identity-links-model.md](../docs-shared/architecture/data-contract/identity-links-model.md) §1.1 — **mirror / canonical (L1-persist / L2-persist)**, bốn vai trò field áp cả hai, links mirror→mirror phục vụ merge sang canonical. [HUONG_DAN_IDENTITY_LINKS.md](05-development/HUONG_DAN_IDENTITY_LINKS.md) mục 2.1; [KHUNG_LUONG_…](05-development/KHUNG_LUONG_INGEST_MERGE_INTEL_CIO_AID_DOMAIN.md) mục 1.1–1.2. *(Từ 2026-04-07: bảng thuật ngữ đầy đủ ở [KHUNG_KHUON…](05-development/KHUNG_KHUON_MODULE_INTELLIGENCE.md) mục 0.)*
...
- ✅ **2026-04-02**: Thêm [KHUNG_LUONG_INGEST_MERGE_INTEL_CIO_AID_DOMAIN.md](05-development/KHUNG_LUONG_INGEST_MERGE_INTEL_CIO_AID_DOMAIN.md) — khung luồng thống nhất CIO / Domain / AID (**Pha ghi thô / merge / intel**), tham chiếu CRM, checklist module khác.
- ✅ **2026-04-07**: Chuẩn hóa thuật ngữ chống nhầm **L1-persist/L2-persist**, **bản ghi chạy intel**, **read model intel**, **Pha ghi thô/merge/intel**, **CIO-T1/T2/T3**, **pipeline rule CIX** — [KHUNG_KHUON_MODULE_INTELLIGENCE.md](05-development/KHUNG_KHUON_MODULE_INTELLIGENCE.md) mục 0; cập nhật [KHUNG_LUONG…](05-development/KHUNG_LUONG_INGEST_MERGE_INTEL_CIO_AID_DOMAIN.md), CIO eventbase, `data-contract.md`, module-map, rule-intelligence, ads-metrics-pipeline, v.v.
