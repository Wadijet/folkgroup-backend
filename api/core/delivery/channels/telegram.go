...
func SendTelegram(ctx context.Context, sender *models.NotificationChannelSender, chatID string, template *RenderedTemplate, historyID string, baseURL string) error {
