...
type AICandidateCreateInput struct {
	GenerationBatchID string                 `json:"generationBatchId" validate:"required"` // ID của generation batch (dạng string ObjectID)
	...
	CreatedByAIRunID  string                 `json:"createdByAIRunId" validate:"required"` // ID của AI run tạo ra candidate này (dạng string ObjectID)
